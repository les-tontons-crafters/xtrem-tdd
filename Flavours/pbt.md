...
![Example based](img/pbt-example-based.png)
...
![Property based details](img/pbt-details.png)

With PBT, the promise is to be on the top right of our previous quadrant :

![PBT quadrant](img/pbt-quadrant.png)
...
![Shrinking / Generation](img/pbt-generator.png)
