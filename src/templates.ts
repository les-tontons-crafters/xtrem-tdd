export default {
  copyright: `
            <a href="https://github.com/les-tontons-crafters/xtrem-tdd/" target="_blank">© Les Tontons Crafters</a>
            <a href="https://creativecommons.org/licenses/by-sa/4.0/" target="_blank">
              ...
              `,
  github: `
  <button id="open-graph-btn" title="Go to Github" type="button"
    aria-label="Go to Github" aria-live="polite"
    onclick="window.open('https://github.com/les-tontons-crafters/xtrem-tdd/', '_blank')">
      ...
      <span class="burger-only" style="margin-left: 1rem; font-size: 1rem">Github</span>
  </button>
  <style>
